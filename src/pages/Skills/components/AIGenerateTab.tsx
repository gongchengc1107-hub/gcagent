...
/** 智能生成 Skill Tab — 两轮 AI 对话，生成完成后自动填入手动填写表单 */
const AIGenerateTab: FC = () => {
  const {
    userInput,
    phase,
    isStreaming,
  ...
  const { startAnalysis, submitAnswers, stopGeneration } = useAISkillGeneration()
    ...
    <div className="flex flex-col gap-4 pt-2">
      ...
      <div className="flex flex-col gap-2">
        <TextArea
          ...
          placeholder="请描述这个 Skill 应该做什么、什么时候应该用等等，尽量描述全面来获取更好的结果"
          rows={4}
          maxLength={10000}
          showCount
          disabled={phase !== 'idle'}
